...
As I said in the conclusion of part 1 of this series, the function I wrote in [that post](http://lucasmreis.github.io/blog/learning-elm-part-1/) felt very *reliable*, in a way that's difficult to achieve with any javascript code.
...
In the end, I maintained the four unit tests that I knew were important cases, and added the fuzz test. [Here's how the final test file looks](https://github.com/lucasmreis/learning-elm/blob/master/part-4/tests/Tests.elm).
